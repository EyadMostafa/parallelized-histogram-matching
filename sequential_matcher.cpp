...
void SequentialMatcher::computeCDF(const cv::Mat& image, float cdf_B[256], float cdf_G[256], float cdf_R[256]) {
...
void SequentialMatcher::generateLUTs(const float src_cdf_B[256], const float src_cdf_G[256], const float src_cdf_R[256],
...
void SequentialMatcher::applyLUT(cv::Mat& frame, const uchar lut_B[256], const uchar lut_G[256], const uchar lut_R[256]) {
...
void SequentialMatcher::matchHistogram(cv::Mat& frame, const float ref_cdf_B[256], const float ref_cdf_G[256], const float ref_cdf_R[256]) {
